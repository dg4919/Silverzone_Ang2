...
namespace Silverzone.Data
{
    internal class ClassUtility
    {
        ...
        public static List<string> upload_Images_toTemp(string tempPath, int reqImg_Width = 300, int reqImg_Height = 300)
        {
            ...
            var a = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath);
            var b = HttpContext.Current.Request.AppRelativeCurrentExecutionFilePath;
            ...
            for (var i = 0; i < files.Count; i++)
            {
                ...
                filesPath.Add(tempPath + FullfileName);
