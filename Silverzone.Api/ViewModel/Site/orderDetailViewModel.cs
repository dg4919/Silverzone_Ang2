    ...
    public class bookModel
    {
        ...
        private static bookModel getModel(OrderDetail model)
        {
            ...
            if (model.Book != null)
            {
                ...
                bookModel.bookCategory = model.Book.Category.Name;    // navigation property to fetch data
                bookModel.className = model.Book.Class.className;
                bookModel.subject = model.Book.Subject.Name;
            ...
            else
            {
                ...
                {
                    SubjectName = x.book.Subject.Name,
